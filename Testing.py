...
def update_music():
    ...
    if current_time >= next_note_time:
        ...
        current_note += 1
        print("--------------------")
        print("current note number: (" + str(current_note) + ")")
        print("--------------------")
        if style == 0:
            print("synth wave selected: Wait (0)")
            print("--------------------")
        elif style == 1:
            print("synth wave selected: square (1)")
            print("--------------------")
        elif style == 2:
            print("synth wave selected: sine (2)")
            print("--------------------")
        elif style == 3:
            print("synth wave selected: Audio file (3)")
            print("--------------------")
        else:
            print("--------------------")
            print("A ERROR HAS OCCURED WITHIN LINES 74 to 96")
            print("it's most likely that you forgot that you forgot to add a zero within the list")
